...
namespace Data_Structure_Exp
{
    ...
    //    }
    //}
    public class Exp1 //Sequential List & Linked List
    {
    ...
    class Exp7 //Sort
    {
        public void InsertSort(Exp1.SeqList<int> seqList)//[o(n),o(n^2)]
        {
        ...
        public void BubbleSort(Exp1.SeqList<int> seqList)//[o(n),o(n^2)]
        {
            int temp;
        ...
        public void SimpleSelectSort(Exp1.SeqList<int> seqList)//o(n(n-1)/2)
        {
            int temp=0, t = 0;
            for(int i = 0; i < seqList.Last; i++)
            {
        ...
        public void QuickSort(Exp1.SeqList<int> seqList,int low,int high)//[o(n*log2(n)),o(n^2)],[total bitree-total,right tree]
        {
            ...
            while (low < high)
            {
                ...
                --high;
                seqList[low] = temp;
                if (i < low - 1) QuickSort(seqList, i, low - 1);
                if (low + 1 < j) QuickSort(seqList, low + 1, j);
            }
        }
        public void CreateHeap(Exp1.SeqList<int> seqList, int low, int high)
        {
            int j = 0, temp = 0, k = 0;
        ...
        public void HeapSort(Exp1.SeqList<int> seqList)//o(n*log2(n))
        {
            int temp = 0;
        ...
        public void Merge(Exp1.SeqList<int> seqList,int len)
        {
        ...
        public void MergeSort(Exp1.SeqList<int> seqList)//time:o(n*log2(n));space:o(n)
        {
            int k = 1;
    ...
    class Exp8 //Search
    {
        public int SeqSearch(Exp1.SeqList<int> seqList,int data)//o(n)
        {
            seqList[0] = data;
            int i = 0;
            for (i = seqList.GetLength(); seqList[i] > data; --i) ;
            return i;
        }
        public int BinarySearch(Exp1.SeqList<int> seqList, int key)//o(log2(n))
        {
            seqList[0] = key;
